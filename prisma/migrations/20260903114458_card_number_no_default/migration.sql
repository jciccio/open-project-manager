...
INSERT INTO "new_Card" ("columnId", "completedAt", "createdAt", "description", "dueDate", "id", "isArchived", "number", "order", "owner", "parentId", "points", "priority", "projectId", "title", "typeId", "updatedAt") SELECT "columnId", "completedAt", "createdAt", "description", "dueDate", "id", "isArchived", "number", "order", "owner", "parentId", "points", "priority", "projectId", "title", "typeId", "updatedAt" FROM "Card";
DROP TABLE "Card";
